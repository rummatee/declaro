...
## Implemented
- Open and save files
- Edit simple strings, variable references, attribute-sets, lambdas, let-in-expressions
...
![screenshot with type change selection open](doc/Screenshot_select_type.png)


## Roadmap
- Support lists, with-expressions, assertions, inherit, imports, numbers, booleans and paths
